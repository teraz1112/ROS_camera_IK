...
def Run(ct,*args):
    ...
    for i in range(500):
        ...
        # g_camera1=MakeCameraAxis(t_miss,roll1_miss,pitch1_miss,yaw1_miss,g_tp1)
        # g_camera2=MakeCameraAxis(t_miss,roll1_miss,pitch1_miss,yaw1_miss,g_tp2)
        # g_camera3=MakeCameraAxis(t_miss,roll1_miss,pitch1_miss,yaw1_miss,g_tp3)
        # g_camera4=MakeCameraAxis(t_miss,roll1_miss,pitch1_miss,yaw1_miss,g_tp4)
        # g_camera5=MakeCameraAxis(t_miss,roll1_miss,pitch1_miss,yaw1_miss,g_tp5)  
        # g_camera6=MakeCameraAxis(t_miss,roll1_miss,pitch1_miss,yaw1_miss,g_tp6)  
        ...
        # 係数行列とベクトルの用意
        B = np.array([[g_tp1[0],g_tp1[1],g_tp1[2] , -g_camera1[0]*g_tp1[0],-g_camera1[0]*g_tp1[1],-g_camera1[0]*g_tp1[2],0,0,0,1,0],
        ...
        xc = np.array([g_camera1[0]*4,g_camera1[1]*4,g_camera2[0]*4,g_camera2[1]*4,g_camera3[0]*4,g_camera3[1]*4,g_camera4[0]*4,g_camera4[1]*4,g_camera5[0]*4,g_camera5[1]*4,g_camera6[0]*4,g_camera6[1]*4])
