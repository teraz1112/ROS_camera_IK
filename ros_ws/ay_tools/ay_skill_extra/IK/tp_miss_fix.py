...
def Run(ct,*args):
    ...
    t_fix=[ 1.36632995e-15,  0.00000000e+00, -4.43423271e-15]
    r_fix,p_fix,y_fix=0.2617993877992115, -2.01518698586092e-14, -1.0174142909999823e-14

    #camera_miss
    t_miss=[0+t_fix[0],4,0+t_fix[2]]
    roll1_miss=-np.pi/3+r_fix
    pitch1_miss=0+p_fix
    yaw1_miss=0+y_fix
